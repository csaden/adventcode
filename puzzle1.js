...
but he can't find the right floor - the directions he got are confusing.
...
var answer = input.split('').reduce(function(prev, curr, i, array) {
	if (curr === '(') {
		prev += 1;
	} else if (curr === ')') {
		prev -= 1;
	...
	if (prev === -1) {
		console.log('Enter basement:', i+1);
	}
	return prev;
}, 0);
