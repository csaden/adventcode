...
console.log(main(isSue2));

function main(filterSueFunc) {
    let sues = processData('puzzle16_data.txt'), theSue;
    const clues = {
        children: 3,
        cats: 7,
        samoyeds: 2,
